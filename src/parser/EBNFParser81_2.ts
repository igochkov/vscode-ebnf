...
import { EBNFParser81_2Listener } from "./EBNFParser81_2Listener.js";
import { EBNFParser81_2Visitor } from "./EBNFParser81_2Visitor.js";
...
export class EBNFParser81_2 extends antlr.Parser {
    ...
    public get grammarFileName(): string { return "EBNFParser81_2.g4"; }
    public get literalNames(): (string | null)[] { return EBNFParser81_2.literalNames; }
    public get symbolicNames(): (string | null)[] { return EBNFParser81_2.symbolicNames; }
    public get ruleNames(): string[] { return EBNFParser81_2.ruleNames; }
    public get serializedATN(): number[] { return EBNFParser81_2._serializedATN; }
    ...
    public constructor(input: antlr.TokenStream) {
        super(input);
        this.interpreter = new antlr.ParserATNSimulator(this, EBNFParser81_2._ATN, EBNFParser81_2.decisionsToDFA, new antlr.PredictionContextCache());
    }
    public syntax(): SyntaxContext {
        let localContext = new SyntaxContext(this.context, this.state);
        this.enterRule(localContext, 0, EBNFParser81_2.RULE_syntax);
        let _la: number;
        try {
            ...
            while (_la === 25) {
                ...
                {
                this.state = 2;
                this.match(EBNFParser81_2.GAP_SEPARATOR);
                }
                }
                this.state = 7;
                this.errorHandler.sync(this);
            ...
            this.state = 8;
            this.match(EBNFParser81_2.GAP_FREE_SYMBOL);
            this.state = 12;
            this.errorHandler.sync(this);
            _la = this.tokenStream.LA(1);
            while (_la === 25) {
    ...
    public static readonly _serializedATN: number[] = [
        ...
        0,10,0,12,0,26,9,0,1,0,0,0,1,0,0,0,30,0,5,1,0,0,0,2,4,5,25,0,0,3,
        2,1,0,0,0,4,7,1,0,0,0,5,3,1,0,0,0,5,6,1,0,0,0,6,8,1,0,0,0,7,5,1,
        0,0,0,8,12,5,20,0,0,9,11,5,25,0,0,10,9,1,0,0,0,11,14,1,0,0,0,12,
        10,1,0,0,0,12,13,1,0,0,0,13,24,1,0,0,0,14,12,1,0,0,0,15,19,5,20,
        0,0,16,18,5,25,0,0,17,16,1,0,0,0,18,21,1,0,0,0,19,17,1,0,0,0,19,
    ...
    public static get _ATN(): antlr.ATN {
        if (!EBNFParser81_2.__ATN) {
            EBNFParser81_2.__ATN = new antlr.ATNDeserializer().deserialize(EBNFParser81_2._serializedATN);
        }

        return EBNFParser81_2.__ATN;
    }


    private static readonly vocabulary = new antlr.Vocabulary(EBNFParser81_2.literalNames, EBNFParser81_2.symbolicNames, []);

    public override get vocabulary(): antlr.Vocabulary {
        return EBNFParser81_2.vocabulary;
    }

    private static readonly decisionsToDFA = EBNFParser81_2._ATN.decisionToState.map( (ds: antlr.DecisionState, index: number) => new antlr.DFA(ds, index) );
}
...
export class SyntaxContext extends antlr.ParserRuleContext {
    ...
    public GAP_FREE_SYMBOL(): antlr.TerminalNode[];
    public GAP_FREE_SYMBOL(i: number): antlr.TerminalNode | null;
    public GAP_FREE_SYMBOL(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    	if (i === undefined) {
    		return this.getTokens(EBNFParser81_2.GAP_FREE_SYMBOL);
    	} else {
    		return this.getToken(EBNFParser81_2.GAP_FREE_SYMBOL, i);
    	}
    }
    public GAP_SEPARATOR(): antlr.TerminalNode[];
    public GAP_SEPARATOR(i: number): antlr.TerminalNode | null;
    public GAP_SEPARATOR(i?: number): antlr.TerminalNode | null | antlr.TerminalNode[] {
    	if (i === undefined) {
    		return this.getTokens(EBNFParser81_2.GAP_SEPARATOR);
    	} else {
    		return this.getToken(EBNFParser81_2.GAP_SEPARATOR, i);
    	}
    }
    public override get ruleIndex(): number {
        return EBNFParser81_2.RULE_syntax;
    }
    public override enterRule(listener: EBNFParser81_2Listener): void {
        if(listener.enterSyntax) {
             listener.enterSyntax(this);
        }
    }
    public override exitRule(listener: EBNFParser81_2Listener): void {
        if(listener.exitSyntax) {
             listener.exitSyntax(this);
        }
    }
    public override accept<Result>(visitor: EBNFParser81_2Visitor<Result>): Result | null {
